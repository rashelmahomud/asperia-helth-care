  ...
  return (
    <div>
      <div className={`bg-no-repeat bg-cover lg:p-32`} style={{ backgroundImage: `url(${depertments?.image})`}}>
        ...
        <h2 className="text-5xl font-semibold text-gray-800">{depertments?.name}</h2>
      </div>
      <div className="lg:p-32">
        ...
        <h2 className="text-5xl font-semibold my-5 text-gray-700">Consultation & Appointment</h2>
        <p className="text-gray-500">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quod vitae consectetur deleniti reiciendis ex iure nesciunt illo, autem ullam ducimus a maiores cumque praesentium quae aut impedit earum labore, exercitationem adipisci, corporis quia? Sequi, placeat molestias necessitatibus incidunt dolores accusamus dolore consectetur architecto quis sed recusandae cumque repudiandae, quaerat aspernatur?</p>
      </div>
    </div>
  );
};
