...
const DoctorallDetails = () => {
  ...
  return (
    <div>
      ...
      <div className="bg-[url('/asperia/cta-one-img.png')] bg-no-repeat bg-[#16243d] border-4 border-iconBg lg:mx-32 p-5 m-10 rounded-lg text-white shadow-[0_10px_40px_rgba(0,0,0,0.6)] drop-shadow-2xl relative">
